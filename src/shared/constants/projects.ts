...
export const PROJECTS: Project[] = [
  {
    ...
    description:
      "Компонент регистрации с комплексной валидацией нескольких полей. Система отслеживает пустые значения и некорректный формат почты, динамически подставляя имена полей в сообщения об ошибках.",
    image: "/projects/signup-form.png",
    stack: ["React", "JavaScript", "Flexbox", "CSS Variables", "Vercel"],
    link: "https://mmalabugin.ru/IntroComponentWithSignupForm/",
    github: "https://github.com/1t1sCooL/IntroComponentWithSignupForm",
  },
  {
    id: "base-apparel-coming-soon",
    title: "Base Apparel Coming Soon Page",
    description:
      "Целевая страница с асимметричным дизайном и фоновыми изображениями. Включает форму подписки с мгновенной валидацией email и кастомными иконками уведомления об ошибках.",
    ...
    github: "https://github.com/1t1sCooL/BaseApparelComingSoon",
  },
  {
