...
export const PROJECTS: Project[] = [
  {
    ...
    title: "Contact Form",
    description:
      "Доступная контактная форма с клиентской валидацией: обязательные поля, e‑mail, radio‑группа, согласие, ошибки через aria и тост об отправке. Qwik в CSR‑режиме, макет сведён pixel‑perfect.",
    image: "/projects/contact-form.png",
    stack: [
      "Qwik",
      "TypeScript",
      "Vite",
    ...
    link: "https://mmalabugin.ru/ContactForm/",
    github: "https://github.com/1t1sCooL/contact-form-main",
  },
  {
    id: "fylo-dark-theme-landing",
    title: "Fylo Dark Theme Landing Page",
    description:
      "Многосекционный лендинг в тёмной теме: hero, фичи, отзывы, форма подписки с валидацией. SolidJS, локальные вариативные шрифты без layout shift, высота страницы совпадает с макетом до пикселя.",
    image: "/projects/fylo-dark-landing.png",
    stack: [
      "SolidJS",
      "TypeScript",
      "Vite",
    ...
    link: "https://mmalabugin.ru/FyloDarkThemeLandingPage/",
    github: "https://github.com/1t1sCooL/fylo-dark-theme-landing-page-master",
  },
  {
    id: "hotel-booking-confirmation",
    title: "Hotel Booking Confirmation Page",
    description:
      "Страница подтверждения брони отеля: боковая навигация, «веер» из чека и приветственной карточки с hover‑анимацией, карточки заезда, Wi‑Fi и завтрака. Vue 3 + TypeScript, mobile‑first.",
    ...
    link: "https://mmalabugin.ru/HotelBookingConfirmationPage/",
    github: "https://github.com/1t1sCooL/hotel-booking-confirmation-page-main",
  },
  {
    id: "clipboard-landing",
    title: "Clipboard Landing Page",
    description:
      "Маркетинговый лендинг с адаптивными фоновыми изображениями, блоками фич и сеткой логотипов. Angular со standalone‑компонентами и signals, шрифт захощен локально с font-display: optional.",
    image: "/projects/clipboard-landing.png",
    stack: [
      "Angular",
      "TypeScript",
      "Signals",
    ...
    link: "https://mmalabugin.ru/ClipboardLandingPage/",
    github: "https://github.com/1t1sCooL/clipboard-landing-page-master",
  },
  {
    id: "sunnyside-agency-landing",
    title: "Sunnyside Agency Landing Page",
    description:
      "Яркий лендинг креативного агентства: мобильное меню, art‑directed картинки через picture, галерея и отзывы. Angular standalone‑компоненты + signals, самохостинг шрифтов Barlow и Fraunces.",
    ...
    link: "https://mmalabugin.ru/SunnysideAgencyLandingPage/",
    github: "https://github.com/1t1sCooL/sunnyside-agency-landing-page-main",
  },
  {
    id: "grid-landing-page",
    title: "Grid Landing Page",
    description:
      "Лендинг благотворительной организации на строгой сетке: hero и четыре стат‑карточки с hover/focus через :has(), мобильное меню с inert. Next.js со static export и self‑hosted Inter через next/font.",
    image: "/projects/grid-landing.png",
    stack: [
      "Next.js",
      "React",
      "TypeScript",
    ...
    link: "https://mmalabugin.ru/GridLandingPage/",
    github: "https://github.com/1t1sCooL/grid-landing-page-main",
  },
  {
    id: "news-homepage",
    title: "News Homepage",
    description:
      "Главная новостного издания: адаптивная сетка из hero‑статьи, колонки «New» и нумерованного топа, мобильное меню с оверлеем. Next.js + next/font, hero‑картинка через picture под разные экраны.",
    image: "/projects/news-homepage.png",
    stack: [
      "Next.js",
      "React",
      "TypeScript",
    ...
    link: "https://mmalabugin.ru/NewsHomepage/",
    github: "https://github.com/1t1sCooL/news-homepage-main",
  },
  {
    id: "bento-grid",
    title: "Bento Grid",
    description:
      "Bento‑раскладка из восьми карточек, которая перестраивается между мобильным, планшетом и десктопом через grid-template-areas. Svelte 5 + Vite, размеры сняты с дизайн‑макетов.",
    ...
    link: "https://mmalabugin.ru/BentoGrid/",
    github: "https://github.com/1t1sCooL/bento-grid-main",
  },
  {
    id: "fylo-data-storage",
    title: "Fylo Data Storage Component",
    description:
      "Виджет использованного хранилища с анимацией: плавное заполнение шкалы, count‑up счётчика и пульсирующий ползунок на CSS keyframes. Angular 20 standalone‑компонент на signals, SCSS.",
    image: "/projects/fylo-data-storage.png",
    stack: [
      "Angular",
      "TypeScript",
      "Signals",
    ...
    link: "https://mmalabugin.ru/FyloDataStorageComponent/",
    github: "https://github.com/1t1sCooL/fylo-data-storage-component",
  },
  {
    id: "testimonials-grid",
    title: "Testimonials Grid Section",
    description:
      "Секция отзывов на CSS Grid с именованными областями: пять карточек разного размера и цвета, три раскладки под экраны. Vue 3 + TypeScript, данные отзывов в отдельном модуле, структура по FSD.",
    image: "/projects/testimonials-grid.png",
    stack: [
      "Vue 3",
      "TypeScript",
      "Vite",
    ...
    link: "https://mmalabugin.ru/TestimonialsGridSection/",
    github: "https://github.com/1t1sCooL/testimonials-grid-section",
  },
  {
