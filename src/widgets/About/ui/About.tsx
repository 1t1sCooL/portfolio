        ...
        <div className={styles.revealSlide}>
          <div className={styles.content}>
            ...
            <div className={styles.text}>
              <p>
                Привет! Я Михаил, frontend-разработчик с фокусом на создании
                высокопроизводительных веб-приложений на React и Next.js. Мой
                подход базируется на архитектурной чистоте и удобстве для
